...
clear;clc;
pd_100 = rosbag('bag_files/SS_CT_100N.bag'); % load bag file
pd_500 = rosbag('bag_files/SS_CT_500N.bag'); % load bag file
pd_1000 = rosbag('bag_files/SS_CT_1000N.bag'); % load bag file
pd_2000 = rosbag('bag_files/SS_CT_2000N.bag'); % load bag file
...
plot(rpy_100.("/teeterbot/rpy Properties")(504:580,2))
hold on
plot(rpy_500.("/teeterbot/rpy Properties")(502:583,2))
hold on
plot(rpy_1000.("/teeterbot/rpy Properties")(260:343,2))
hold on
plot(rpy_2000.("/teeterbot/rpy Properties")(272:342,2))
xlabel('Time [sec]')
ylabel('Pitch [radians]')
xlim([0 50])
